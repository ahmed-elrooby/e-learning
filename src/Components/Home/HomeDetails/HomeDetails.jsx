...
const HomeDetails = () => {
  ...
  <div className="flex flex-col items-start gap-4 ">
    <span className="w-[20px] h-[20px] text-[--main-color] border-2 border-[--main-color]  animate-spin"></span>
            ...
            <Link className="rounded-lg text-white hover:bg-[#f97316a6]  capitalize text-[20px] px-[15px] py-[8px]  transition-all bg-[--main-color] w-max font-bold  " href="/SignUp">join us</Link>
